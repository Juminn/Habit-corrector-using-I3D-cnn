...
def run_training():
    ...
    ckpt = 1 # 내가
    model_checkpoint_path = '..\\..\\checkpoints\\flow_imagenet\\model.ckpt'#내가넣음
    if ckpt and model_checkpoint_path:
        print("loading checkpoint %s,waiting......" % model_checkpoint_path)
        flow_saver.restore(sess, model_checkpoint_path)
        print("load complete!")
    ...
    for step in xrange(FLAGS.max_steps):
        ...
        if (step+1) % 300 == 0 or (step + 1) == FLAGS.max_steps:
